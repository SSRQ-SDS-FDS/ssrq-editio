...
import processSpanMarkes from './components/spans.js';
...
documentStore.registerTabActivationCallback('transcriptCol', processSpanMarkes);
documentStore.registerTabActivationCallback('normalized', processSpanMarkes);
